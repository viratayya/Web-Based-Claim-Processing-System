<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Cpd_view_feedback.aspx.cs" Inherits="Cpd_view_feedback" %>
...
<body style="font-size:medium; color:Purple; font-family:Times New Roman Baltic;">
    ...
    <tr><td width="20%">
     ...
     <td><table>
    <tr>
    <td style="font-family:Times New Roman Baltic; font-size:x-large; color:red">Feedbacks:</td>
    </tr>
    <tr>
